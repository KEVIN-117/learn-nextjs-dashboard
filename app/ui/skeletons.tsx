    ...
    [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      ...
      <td className="whitespace-nowrap py-3 pl-6 pr-3">
        <div className="flex justify-end gap-3">
          <div className="h-[38px] w-[38px] rounded bg-gray-200 dark:bg-gray-700"></div>
          <div className="h-[38px] w-[38px] rounded bg-gray-200 dark:bg-gray-700"></div>
        </div>
      </td>
    </tr>
...
export function InvoicesMobileSkeleton() {
  return (
    <Card className="mb-2 w-full rounded-md bg-white p-4">
      <div className="flex items-center justify-between border-b border-gray-100 pb-8">
        <div className="flex items-center">
          <div className="mr-2 h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-700"></div>
          <div className="h-6 w-16 rounded bg-gray-200 dark:bg-gray-700"></div>
        </div>
        <div className="h-6 w-16 rounded bg-gray-200 dark:bg-gray-700"></div>
      </div>
      <div className="flex w-full items-center justify-between pt-4">
        <div>
          <div className="h-6 w-16 rounded bg-gray-200 dark:bg-gray-700"></div>
          <div className="mt-2 h-6 w-24 rounded bg-gray-200 dark:bg-gray-700"></div>
        </div>
  ...
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-200 dark:bg-dark-tremor-background-subtle dark:text-gray-100 text-tremor-background-emphasis p-2 md:pt-0">
          ...
          <table className="hidden min-w-full md:table">
            ...
            <tbody className="bg-dark-tremor-background-emphasis dark:bg-dark-tremor-background-main">
              <TableRowSkeleton />
              <TableRowSkeleton />
              <TableRowSkeleton />
              <TableRowSkeleton />

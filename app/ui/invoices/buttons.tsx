...
import { deleteInvoice as Delete } from '@/app/lib/actions';
export function CreateInvoice() {
  return (
    <Link
      href="/dashboard/invoices/create"
      className="flex h-auto items-center rounded-lg bg-blue-600 p-4 text-sm font-medium text-white transition-colors hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
    >
...
export function DeleteInvoice({ id }: { id: string }) {
  const deleteInvoice = Delete.bind(null, id)
  return (
    <>
